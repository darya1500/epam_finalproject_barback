...
<form name="createcocktailform" action="controller" method="POST">
    ...
    <c:forEach var = "i" begin = "1" end = "10">
        <div id="ingredient">
            <fmt:message  key="label.ingredientnameinenglish" />:<input type="text" name="ingredientNameEN${i}">
            <fmt:message  key="label.ingredientnameinrussian" />:<input type="text" name="ingredientNameRU${i}">
