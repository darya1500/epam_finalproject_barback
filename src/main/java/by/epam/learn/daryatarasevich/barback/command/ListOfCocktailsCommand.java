...
public class ListOfCocktailsCommand implements ActionCommand {
    ...
    /**
     * Command defines actions executed with list of users from database barbackdb.cocktails.
     * Operation LOAD loads cocktail from database.
     * Operation UPDATE updates cocktail in database.
     * Operation DELETE deletes cocktail from database.
     * Operation LIST loads list of cocktails from database.
     *
     * @param request
     * @return page
     */
