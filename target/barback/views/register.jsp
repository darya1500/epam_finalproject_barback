...
<fmt:message key="label.password" />:<input type="password" name="password" placeholder="at least 6 symbols"><br /><br />
...
<fmt:message key="label.description" />:<input type="text" name="description" placeholder="Some words about yourself..."><br /><br />
